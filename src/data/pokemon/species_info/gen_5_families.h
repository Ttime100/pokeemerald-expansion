...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_SERPERIOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_GRASS),
        .abilities = { ABILITY_OVERGROW, ABILITY_SHED_SKIN, ABILITY_CONTRARY }, // Added Shed Skin ability
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_EMBOAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_GUTS, ABILITY_RECKLESS },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
    ...
    [SPECIES_SAMUROTT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TORRENT, ABILITY_SHELL_ARMOR, ABILITY_SHARPNESS }, // Added Sharpness as Hidden Ability
        .bodyColor = BODY_COLOR_BLUE,
