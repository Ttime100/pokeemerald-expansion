...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_OVERGROW, ABILITY_LEAF_GUARD, ABILITY_MEGA_SOL }, // Added Mega Sol as Hidden Ability
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BLAZE, ABILITY_FLASH_FIRE, ABILITY_BLAZING_SOUL }, // Added Blazing Soul as hidden ability
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_TORRENT, ABILITY_STRONG_JAW, ABILITY_SHEER_FORCE }, // Added Strong Jaw ability
        .bodyColor = BODY_COLOR_BLUE,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    {
        .baseHP        = 75,
        .baseAttack    = 85,  //CHANGED FROM 105
        .baseDefense   = 85,  //CHANGED FROM 75
        .baseSpeed     = 45,
        .baseSpAttack  = 125, //CHANGED FROM 105
        .baseSpDefense = 85,  //CHANGED FROM 75
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 75,
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_SNIPER, ABILITY_MEGA_LAUNCHER }, //CHANGED MOODY TO MEGA LAUNCHER
    #else
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_EARLY_BIRD, ABILITY_FLASH_FIRE, ABILITY_SOLAR_POWER }, // Ttime100 changed hidden ability from Unnerve
        .bodyColor = BODY_COLOR_BLACK,
