...
const u32 gObjectEventPic_ManaphyEgg[] = INCBIN_U32("graphics/object_events/pics/misc/manaphy_egg.4bpp");
const u16 gObjectEventPal_ManaphyEgg[] = INCBIN_U16("graphics/object_events/pics/misc/manaphy_egg.gbapal");
