...
{
    {COMPOUND_STRING("50 Coins{CLEAR_TO 72}¥100")}, //Ttime100 Changed from 1,000
    {COMPOUND_STRING("500 Coins{CLEAR_TO 72}¥1,000")}, //Ttime100 Changed from 10,000
    {COMPOUND_STRING("5,000 Coins{CLEAR_TO 72}¥10,000")}, //Ttime100 Added Extra Option
    {gText_Exit},
};
...
static const struct MenuAction MultichoiceList_DeoxysForms[] =
{
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_DEOXYS_FORM]                                = MULTICHOICE(MultichoiceList_DeoxysForms),
};
