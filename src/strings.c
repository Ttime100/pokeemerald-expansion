...
const u8 gText_MenuRepelOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Repel"); // L-Menu
const u8 gText_MenuRepelOff[] = _("{COLOR RED}{SHADOW LIGHT_RED}Repel"); // L-Menu
const u8 gText_AutoRunOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Auto Run"); // L-Menu
const u8 gText_AutoRunOff[] = _("{COLOR RED}{SHADOW LIGHT_RED}Auto Run"); // L-Menu
