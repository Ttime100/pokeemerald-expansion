...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_LIBERTY_GARDEN] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_FLOWER_GARDEN] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_SEAFLOOR_RUINS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_ANCIENT_COLONNADE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_FLOWER_GARDEN] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_SEAFLOOR_RUINS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ANCIENT_COLONNADE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
};
