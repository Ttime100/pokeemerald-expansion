...
#define B_VAR_STARTING_STATUS       VAR_BATTLE_STARTING_STATUS     // If this var has a value, assigning a STATUS_FIELD_xx_TERRAIN to it before battle causes the battle to start with that terrain active.
