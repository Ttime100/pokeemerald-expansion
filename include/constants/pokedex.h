...
enum NationalDexOrder
{
    ...
    NATIONAL_DEX_UNOWN,
    NATIONAL_DEX_WOBBUFFET, // Moved Giraffarig
    NATIONAL_DEX_PINECO,
    NATIONAL_DEX_FORRETRESS, // Moved Dunsparce
    NATIONAL_DEX_GLIGAR,
    ...
    NATIONAL_DEX_MANECTRIC, // Moved Plusle and Minun
    ...
    NATIONAL_DEX_TROPIUS, // Moved Chimecho
    NATIONAL_DEX_ABSOL,
    NATIONAL_DEX_WYNAUT,
    ...
    NATIONAL_DEX_PURUGLY, // Moved Chingling
    NATIONAL_DEX_STUNKY,
    ...
    //This is to prevent issues with the pokedex order and to keep the code clean.
